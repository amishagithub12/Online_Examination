...
<div class="col-md-6 col-md-offset-3">
	...
	<?php } ?>
	<?php if($_SESSION['current_que'] == 5){ ?>
				<button style="height:6%" type="" id="submit" class="btn btn-primary"><a href="result_count.php" class="btn style1"><font color="#FFFFFF">submit</font></a><i class="fa fa-fw fa-arrow-right"></i></button>
	<?php } ?>
  </div>
