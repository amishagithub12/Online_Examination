        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="fregister.php" method="POST" enctype="multipart/form-data">                 
...
{ 
	...
	$p=md5($pwd);
	$sub=$_POST['sub'];
	$sqli="INSERT INTO `faculty_master`( `fname`,`email`, `password`,`main_subject`) VALUES ('$fname','$email','$p','$sub')";
	$ans=$conn->query($sqli); 
